...
from firstagent.crew import Firstagent
...
def run():
    ...
    """
    inputs = {
        'topic': 'Milk Consumption for Human Health',
...
def test():
    ...
    try:
        Firstagent().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
